...
-- Tiempo de generación: 19-01-2022 a las 16:57:28
...
(85, 45, 'rubensantibanezacosta902@gmail.com', 'tIBURCIO ESTA MIRANDO', '2022-01-18 18:38:21'),
...
('rubensantibanezacosta@alumno.ieselrincon.es', 'RUBEN', 'SANTIBA�EZ ACOSTA', 'https://lh3.googleusercontent.com/a/AATXAJzWGrMlSLuRFyd-6biApoDmcpA_WZ1lturX0k-h=s96-c', 'user', 4.14286, '2021-12-06', '2022-01-18 18:39:29', '2022-01-18'),
('rubensantibanezacosta902@gmail.com', 'Ruben', 'Santibañez Acosta', 'https://lh3.googleusercontent.com/a-/AOh14GgjgHJCX6j5b6KjotaQjiyPONsEVnOl8VMDpbllMK8=s96-c', 'user', 4.4, '2021-12-06', '2022-01-18 18:43:44', '2022-01-18'),
...
('GC', 'Gran Canaria', 2.625, '2021-11-13', '2021-12-24'),
('TNF', 'Tenerife', 1.25, '2021-11-19', '2021-12-24'),
('VIRTUAL', 'Virtual', 1.5, '2021-11-13', '2021-12-24');
...
--
ALTER TABLE `comments`
  MODIFY `comment_id` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT de la tabla `events`
--
ALTER TABLE `events`
  MODIFY `event_id` float NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
